          ...
          {feelingData.length < 2 ? (
            ...
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={feelingData} margin={{ top: 4, right: 4, bottom: 0, left: -20 }}>
                ...
                <XAxis dataKey="date" tick={{ fontFamily: 'Nunito', fontSize: 11, fill: '#9b89c4', angle: -90, textAnchor: 'end', dominantBaseline: 'auto' }} tickLine={false} axisLine={false} interval={0} height={60} />
